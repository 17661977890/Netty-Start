package com.netty.chat.rpc.client;

import com.netty.chat.protocol.MessageCodecSharable;
import com.netty.chat.protocol.ProcotolFrameDecoder;
import com.netty.chat.rpc.handler.RpcResponseMessageHandler;
import com.netty.chat.rpc.message.RpcRequestMessage;
import com.netty.chat.rpc.protocol.SequenceIdGenerator;
...
//        service.sayHello("嘿！");
    ...
    private static void initChannel() {
        ...
        MessageCodecSharable MESSAGE_CODEC = new MessageCodecSharable(); // 【使用 netty.chat包方法】
        ...
        bootstrap.handler(new ChannelInitializer<SocketChannel>() {
            ...
            protected void initChannel(SocketChannel ch) throws Exception {
                ch.pipeline().addLast(new ProcotolFrameDecoder()); // 【使用 netty.chat包方法】
